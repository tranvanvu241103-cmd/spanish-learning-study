...
baseItems.push(
  ...
  {lesson:"Lesson 12",topic:"Entertainment",spanish:"el drama",english:"the drama",vi:"bi kịch",example:"El drama es interesante.",exampleEn:"The drama is interesting.",approx:"el dra-ma",ipa:"el ˈdɾama",explain:"Drama ends in -ma, one of the Greek-origin -ma nouns that are masculine despite ending in -a.",visual:"🎭"},
  ...
  {lesson:"Lesson 12",topic:"Abstract ideas",spanish:"el problema",english:"the problem",vi:"vấn đề",example:"Tengo un problema.",exampleEn:"I have a problem.",approx:"el pro-ble-ma",ipa:"el pɾoˈβlema",explain:"Problema ends in -ma, one of the Greek-origin -ma nouns that are masculine despite ending in -a.",visual:"❗"},
  {lesson:"Lesson 12",topic:"Entertainment",spanish:"el programa",english:"the program",vi:"chương trình",example:"El programa es bueno.",exampleEn:"The program is good.",approx:"el pro-gra-ma",ipa:"el pɾoˈɣɾama",explain:"Programa ends in -ma, one of the Greek-origin -ma nouns that are masculine despite ending in -a.",visual:"📺"},
...
baseItems.push(
  ...
  {lesson:"Lesson 14",topic:"Entertainment",spanish:"la televisión",english:"the television",vi:"tivi",example:"Me gusta la televisión.",exampleEn:"I like television.",approx:"la te-le-bi-sion",ipa:"la teleβiˈsjon",explain:"Televisión ends in -sión, one of the endings that are always feminine.",visual:"📺"},
